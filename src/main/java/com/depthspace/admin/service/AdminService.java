...
public interface AdminService {
    ResultResponse createAdmin(CreateAdminRequest createAdminRequest);
    ResultResponse adminLogin(AdminLoginRequest adminLoginRequest) throws JsonProcessingException;
