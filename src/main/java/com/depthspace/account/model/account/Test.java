...
public class Test {
	public static void main(String[] args) {
		...
		AccountDAO_Interface accountDAO2 = new AccountJDBCDAO();

		// 測試用插入一筆資料
//	    accountVO.setAccountId(5);
//	    accountVO.setAccountName("閔萱超極讚");
...
//		System.out.println("已取得全部資料");
		...
		// 測試用主鍵取得一列資料
//		AccountVO vo = accountDAO.findByPrimaryKey(1);
//		if (vo != null) {
//			System.out.println("ACCOUNT_ID:" + vo.getAccountId());
//			System.out.println("ACCOUNT_NAME:" + vo.getAccountName());
//			System.out.println("MEM_ID:" + vo.getMemId());
