	...
	<div class="container mt-5">
		<h5>專欄類型</h5>
	           ...
	           <thead>
				...
				<tbody>
				    <c:forEach var="columnType" items="${listAll}" varStatus="status">
				   			<td style="display: none;">${columnType.colTypeId}</td>
...
$(document).ready(function() {
    ...
    $(document).on('click', '.edit-btn', function() {
        ...
        var colTypeName = currentRow.find('.col-type-name').text();
        currentRow.find('.col-type-name').hide();
