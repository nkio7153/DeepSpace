      ...
      <div class="col-lg-10">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="keywordQa.do" name="form1">
                            <div class="form-group">
                                <label>SerialId:</label>
                                <input type="text" class="form-control" name="serialId" value="<%=keywordQaVO.getSerialId()%>" readonly>
                            </div>
                            <div class="form-group">
                                <label>關鍵字編號:</label>
                                <input type="text" class="form-control" name="kwTypes" value="<%=keywordQaVO.getKwTypes()%>">
                            </div>
                            <div class="form-group">
                                <label>關鍵字名稱:</label>
                                <input type="text" class="form-control" name="kwAns" value="<%=keywordQaVO.getKwAns()%>">
                            </div>
