  ...
  <div class="row">
    <div class="col-lg-8">
      ...
      <div class="mb-4 border rounded shadow-sm p-3">
        ...
        <div>
          <input type="radio" name="paymentMethod" checked value="1"><span class="fs-5">信用卡</span><br>
        </div>
        <div>
          <input type="radio" name="paymentMethod" value="2"><span  class="fs-5">轉帳</span><br>
        </div>
        <div>
          <input type="radio" name="paymentMethod" value="3"><span  class="fs-5">行動支付</span><br>
        </div>
      </div>
      <!-- <div class="mb-4 border rounded shadow-sm p-3">
    ...
    <div class="col-lg-4">
      <div class="mb-4 border rounded shadow-sm p-3">
        ...
        <table class="table">
          ...
          <tr>
            <td>${cart.ticketName}</td>
            <td>$${cart.price}</td>
            <td>${cart.quantity}</td>
            <td class="sub">$${cart.subtotal}</td>
          </tr>
          </c:forEach>
        </table>
      </div>
      <div class="fs-3 bg-light p-4 rounded mb-4 border rounded shadow-sm">
        ...
        <span>點數:</span><span class="coupen badge bg-warning">0</span>
      </div>
      <div class="last fs-2 bg-light p-4 rounded border rounded shadow-sm">
        <span class="fs-4">總金額:$</span><div class="total text-black-50 fs-4"></div>
        <br>
